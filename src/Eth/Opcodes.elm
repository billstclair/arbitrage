...
=======
    , ( ( 0x30, "ADDRESS", 30 ), ( "[address]", "write current address at [address]", "Get address of currently executing account" ) )
    , ( ( 0x31, "BALANCE", 100 ), ( "[address]", "balance", "Get balance of the given account" ) )
    , ( ( 0x32, "ORIGIN", 2 ), ( "[]", "address", "Get execution origination address" ) )
    , ( ( 0x33, "CALLER", 2 ), ( "[]", "address", "Get caller address" ) )
    ...
    , ( ( 0x39, "CODECOPY", 3 ), ( "[destOffset,offset,size]", "code", "Copy code running in current environment to memory" ) )
...
{-
   ...
   address
   Halt execution and register account for later deletion or send all Ether to address (post-Cancun)
>>>>>>> 9cbe56988707fcc13e723bd568fcaa3d1f4053d7
-}
